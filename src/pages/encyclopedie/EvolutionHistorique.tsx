...
export function EvolutionHistorique() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 sm:px-6 py-16">
      ...
      <p className="text-sm font-medium text-muted mb-3">Encyclopédie / Évolution</p>
      ...
      <Link
        ...
        className="mt-4 inline-block text-sm font-medium underline decoration-line-2 underline-offset-4 hover:decoration-paper"
      >
      ...
      <section id="frise" className="mt-12" aria-label="Frise interactive">
        ...
        <div className="mt-6 rounded-2xl border border-line p-6 sm:p-8">
          <div className="flex items-baseline justify-between flex-wrap gap-2">
            ...
            <span className="text-sm text-muted">{period.range}</span>
          </div>
          ...
          {entry && (
            <div className="mt-6 pt-6 border-t border-dashed border-line-2 flex items-center justify-between">
              <p className="text-sm text-muted">Fiche véhicule illustrative de cette période</p>
      ...
      <section id="oscillations" className="mt-14">
        ...
        <div className="rounded-2xl border border-line p-4 sm:p-6 h-80">
        ...
        <p className="text-xs text-muted mt-2">Recherche et analyse : Dorra Ben Aissa</p>
      </section>
      ...
      <section id="elements" className="mt-14">
        ...
        <ul className="space-y-2">
          {disappearedTransformedElements.map((el) => (
            <li key={el} className="flex items-start gap-2 text-sm text-dim">
