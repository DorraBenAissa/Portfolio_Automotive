...
export function Comparaison() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 sm:px-6 py-16">
      <p className="text-sm font-medium text-muted mb-3">Encyclopédie / Comparaison</p>
      ...
      <div className="mt-10 rounded-xl border border-amber-800 bg-amber-950/40 p-5">
        <p className="text-sm text-amber-200">{manufacturerAnalysisDisclaimer}</p>
      </div>
    </div>
  )
}
