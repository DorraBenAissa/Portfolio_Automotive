...
export function ResultatsConducteurs() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 sm:px-6 py-16">
      ...
      <p className="text-sm font-medium text-muted mb-3">Recherche / Résultats conducteurs</p>
      ...
      <section id="stat-cle" className="mt-10 rounded-2xl border-2 border-paper p-6 sm:p-10 text-center">
        ...
        <p className="mt-2 text-sm text-muted">{headlineStat.note}</p>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {otherResults.map((r) => (
            <div key={r.id} className="rounded-xl border border-line p-5">
              ...
              <p className="mt-2 text-sm text-muted">{r.question}</p>
