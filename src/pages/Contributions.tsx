...
export function Contributions() {
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 py-16">
      <p className="text-sm font-medium text-stone-500 dark:text-stone-400 mb-3">Contributions</p>
      ...
      <div className="mt-6 rounded-xl border-2 border-stone-900 dark:border-white p-5 text-center font-medium">
        ...
        <div className="flex flex-wrap items-center gap-x-2 gap-y-3">
          {contributionsChronology.map((s, i) => (
            <span key={s} className="flex items-center gap-2">
              ...
              {i < contributionsChronology.length - 1 && <span className="text-stone-400" aria-hidden="true">→</span>}
            </span>
          ))}
        </div>
      </section>
